...
def startGame(screen, sounds, bird_images, other_images, background_images, cfg):
    pygame.display.set_icon(other_images['icon'])
    
    base_pos = [0, cfg.SCREENHEIGHT * 0.79]
    base_diff_bg = other_images['base'].get_width() - background_images.get_width()
    ...
    while True:
        ...
        if bird_idx_change_count % 5 == 0:
            ...
            bird_idx_change_count = 0
        bird_pos[0] = -((-base_pos[0] + 4) % base_diff_bg)
